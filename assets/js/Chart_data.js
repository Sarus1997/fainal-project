...
function loadGraph() {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            var colorPalette = ['#f48fb1', '#b39ddb', '#afbfff', '#80deea', '#72d572', '#e6ee9c'];
            var score = google.visualization.arrayToDataTable([
                ['id_quality', 'Case', { role: 'style' }],
                ['สะอาด', score_clean, colorPalette[0]],
                ['แต่งกาย', score_dress, colorPalette[1]],
                ['สุภาพ', score_polite, colorPalette[2]],
                ['ราคา', score_price, colorPalette[3]],
                ['คุณภาพ', score_quality, colorPalette[4]],
                ['บริการ', score_serve, colorPalette[5]]
            ]);
            ...
            var options_Cleanliness_pie = {
                ...
                is3D: true,
                colors: ['#f69988', '#42bd41', '#0277bd', '#ffe082', '#9292D1'],
